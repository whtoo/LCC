package com.blitz.lcc.parser;

import com.blitz.lcc.inter.*;
import com.blitz.lcc.lexer.*;
import com.blitz.lcc.symbol.Array;
import com.blitz.lcc.symbol.Env;
import com.blitz.lcc.symbol.Type;

import java.io.IOException;

public class Parser {
    private Lexer lex; // 词法分析器引用
    private Token look; // 向前看一个词法单元
    Env top = null;
    int used = 0;
    ...
    void error(String s) { throw new Error("near line "+lex.line+",col"+Lexer.col+": "+s);}
    ...
    Type type() throws IOException {
        Type p = (Type) look;// look.tag == Tag.BASIC
        match(Tag.BASIC);
    ...
    Expr factor() throws IOException {
        ...
        switch (look.tag) {
            ...
            case Tag.ID:
                ...
                Id id = top.get(look);
                if(id == null) error(look.toString() + " undefined");
                move();
